...
3. **Create applications/admissions**
...
- `scripts/SEED_README.md` - Seeding script documentation
- `BUGFIX_FIRESTORE_QUERIES.md` - Query fix explanation
